...
export default function HomeMain() {
    return (
        <div className="flex pt-16">
            ...
            <span className="flex w-1/2 justify-center relative ">
                <Image src={'/bienvenido-lh-consulting.png'} width={544} height={650} alt="bienvenido lh-consulting" />
                <span className=" flex flex-col max-w-sm bg-sky absolute bottom-0 ">
                    ...
                    <span className="text-white text-l px-11">
                        ...
                        <p>Obtener la satisfacción de nuestros clientes mediante soluciones que logren proteger y maximizar sus recursos, todo ello con un grupo de profesionales altamente capacitados, que tienen una amplia experiencia en el ámbito fiscal, legal, contable y outsourcing de compras.</p>
